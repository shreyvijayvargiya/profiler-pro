...
const data = {
	...
	about: {
		text: "Hello, I am John Doe, a Full Stack Developer with 5 years of experience. I love to build mobile, desktop, and web applications and currently building",
		website: {
			text: "iHateReading",
		...
		<div className="min-h-screen relative dark:bg-black transition-colors duration-200">
			...
			<div className="max-w-3xl mx-auto px-4 py-8 relative">
				<div className="0">
					...
					<div className="pl-8 py-10 bg-white/95 dark:bg-black/80 backdrop-blur-sm shadow-2xl border border-zinc-100 dark:border-zinc-900 rounded-xl relative z-1 p-10">
						{/* Hero Section */}
									...
									<div className="flex space-x-6">
										{data.personalInfo.socialLinks.map((link, index) => (
											<a
												...
												className="flex items-center space-x-2 text-zinc-400 hover:text-zinc-500 dark:text-zinc-400 dark:hover:text-zinc-300 transition-colors"
											>
												<link.icon />
						...
						<section className="my-20 ">
							...
							<div className="space-y-4">
								<div className="flex items-center space-x-4">
									<Icons.Mail className="text-zinc-400 dark:text-zinc-400" />
									<a
								...
								<div className="flex items-center space-x-4">
									<Icons.Phone className="text-zinc-400 dark:text-zinc-400" />
									<a
